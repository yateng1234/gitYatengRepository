...
const frameIn = [
  ...
  },
  {
    ...
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'sql', name: `${pre}sql`, component: () => import('@/pages/sys/setting/sql'), meta: { ...meta, title: 'SQL监控' } },
      { path: 'code', name: `${pre}code`, component: () => import('@/pages/sys/setting/code'), meta: { ...meta, title: '代码生成' } }
    ])('sys-setting-')
  },
  {
    ...
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'index', name: `${pre}index`, component: () => import('@/pages/demo/playground/index'), meta: { ...meta, title: '功能首页' } },
  ...
  },
  {
    ...
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'd2-doc', name: `${pre}d2-doc`, component: () => import('@/pages/demo/frame/d2-doc'), meta: { ...meta, title: 'SuntrayAdmin 中文文档' } }
    ])('demo-frame-')
  },
  {
    path: '/demo/d2-crud',
    ...
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'index', name: `${pre}index`, component: () => import('@/pages/demo/d2-crud/index'), meta: { ...meta, title: '表格组件 首页' } },
  ...
  },
  {
    ...
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'table/1', name: `${pre}index`, component: () => import('@/pages/demo/business/table/1'), meta: { ...meta, title: 'Demo' } }
